...
const GLOBAL_LANG = {
    'zh-CN' : {
        ...
        supportversion : '注意: 当前版本保存后的plist文件最高支持官方发布的OpenCore-0.6.7-RELEASE',
        footermessage:'最高支持: OpenCore-0.6.7-RELEASE 修改于20210303 email:295799583@qq.com'
    },
    ...
    'en-US' : {
        ...
        supportversion : 'Note: The plist file saved in the current version supports up to the officially released OpenCore-0.6.7-RELEASE',
        footermessage:'Maximum support: OpenCore-0.6.7-RELEASE Updated 20210303 email:295799583@qq.com'
    }
};
